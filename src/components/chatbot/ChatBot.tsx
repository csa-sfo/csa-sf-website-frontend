...
const ChatBot: React.FC<ChatBotProps> = ({ isOpen, onToggle }) => {
  ...
  return (
    <div className="fixed bottom-24 right-6 z-50 w-80 animate-slide-in-right">
      <Card className="shadow-2xl border border-gray-200 bg-white rounded-2xl overflow-hidden">
        <CardHeader className="bg-gradient-to-r from-csa-blue to-csa-navy text-white p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <Avatar className="h-10 w-10 border-2 border-white/30 bg-white/10">
                <AvatarImage src="/lovable-uploads/6c9d0416-c5cd-4552-baee-a4aaf7ed03e5.png" alt="CSA Bot" className="h-10 w-10 object-contain" />
                <AvatarFallback className="bg-csa-accent text-white text-sm">CSA</AvatarFallback>
              </Avatar>
              <div>
                <CardTitle className="text-base">CSA Bot</CardTitle>
          ...
          <div className="p-3 border-t border-gray-200 bg-white">
            <div className="flex space-x-2">
              <Input
                ...
                className="flex-1 rounded-full bg-gray-50 border-gray-300 focus:border-csa-blue text-gray-800 placeholder:text-gray-500"
              />
              <Button
                onClick={handleSendMessage}
                size="sm"
                className="bg-csa-blue hover:bg-csa-navy text-white rounded-full h-10 w-10 p-0"
              >
