  ...
  return (
    <div className="fixed bottom-4 right-4 z-40">
      <Button
        onClick={onClick}
        size="lg"
        className="bg-gradient-to-r from-csa-blue to-csa-navy hover:from-csa-navy hover:to-csa-blue text-white rounded-full h-14 w-14 p-0 shadow-lg animate-fade-in relative"
      >
